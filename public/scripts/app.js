...
const create_profile = async() => {
    ...
    try{
        ...
        const user_profile = `       
            <img id="profile-picture" src="${response.data.avatar_url}" alt="user profile">
            <div id="profile-content">
                ...
                <p id="profile-bio">${response.data.bio}</p>
                <p id="profile-location-website"><strong>Location: </strong>${response.data.location}</p>
